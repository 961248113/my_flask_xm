(function () {
    require.config({
        paths: {
            echarts: "static/echarts/echarts/echarts",
        },
    });

    require(
    [
        "static/echarts/echarts/echarts",
        "static/echarts-2.2.7/extension/BMap/src/main",
        "static/echarts-2.2.7/build/dist/chart/map",
    ],
